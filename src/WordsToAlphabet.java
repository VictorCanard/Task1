...
class RRule{
    ...
    public RRule(char x, char y) {
        this.x = x;
        this.y = y;
    }
}
public class WordsToAlphabet { // WITH A FILE SO EASIER FOR TESTING

    public static List<Character> WTA(String filePath) {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            String prevName = reader.readLine();  // Read user input
